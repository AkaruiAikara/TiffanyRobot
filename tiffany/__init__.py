...
if ENV:
    ...
    from tiffany.config import Development as Config
...
telethn = TelegramClient("tiffany", API_ID, API_HASH)
...
from tiffany.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
