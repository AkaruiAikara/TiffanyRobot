...
from tiffany.modules.helper_funcs.telethn.chatstatus import user_is_admin
from tiffany.modules.helper_funcs.telethn.chatstatus import can_delete_messages
from tiffany.lyn import tiffanybot


@tiffanybot(pattern="^/purge")
