...
from tiffany import dispatcher, WHITELIST_USERS, SARDEGNA_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID
from tiffany.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from tiffany.modules.helper_funcs.extraction import extract_user
from tiffany.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'tiffany/elevated_users.json')
