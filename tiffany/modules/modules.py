...
from tiffany.__main__ import (
    ...
    CHAT_SETTINGS,
    USER_SETTINGS)
from tiffany.modules.helper_funcs.chat_status import sudo_plus, dev_plus
...
def load(_bot: Bot, update: Update):
    ...
    try:
        imported_module = importlib.import_module("tiffany.modules." + text)
    except Exception:
...
def listmodules(_bot: Bot, update: Update):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("tiffany.modules.", 1)[1]
